...
-- -----------------------------------------------------
-- Schema vehicle_reservation_system
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema vehicle_reservation_system
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `vehicle_reservation_system` DEFAULT CHARACTER SET utf8 ;
-- -----------------------------------------------------
-- Table `vehicle_reservation_system`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vehicle_reservation_system`.`user` (
...
-- -----------------------------------------------------
-- Table `vehicle_reservation_system`.`vehicle`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vehicle_reservation_system`.`vehicle` (
...
-- -----------------------------------------------------
-- Table `vehicle_reservation_system`.`booking`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vehicle_reservation_system`.`booking` (
  ...
  CONSTRAINT `user_booking`
    ...
    REFERENCES `vehicle_reservation_system`.`user` (`us_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `vehicle_booking`
    FOREIGN KEY (`bk_vh_id`)
    REFERENCES `vehicle_reservation_system`.`vehicle` (`vh_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 26
...
-- -----------------------------------------------------
-- Table `vehicle_reservation_system`.`role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vehicle_reservation_system`.`role` (
...
-- -----------------------------------------------------
-- Table `vehicle_reservation_system`.`user_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vehicle_reservation_system`.`user_role` (
  ...
  CONSTRAINT `fk_user_role_role1`
    ...
    REFERENCES `vehicle_reservation_system`.`role` (`ro_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
